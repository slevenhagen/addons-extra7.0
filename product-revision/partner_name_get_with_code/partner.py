...
class res_partner(orm.Model):
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        for partner_id, name in res:
            record = self.read(cr, uid, partner_id, ['ref', 'parent_id'], context=context)
            if not record['ref'] and record['parent_id']:
                record = self.read(cr, uid, record['parent_id'][0], ['ref'], context=context)
