...
class hr_expense_line(orm.Model):
    ...
    def _amount_multi_currency(self, cr, uid, ids, field_name, arg, context=None):
        if context is None:
            context = {}
    ...
    _columns = {
        ...
        'total_amount': fields.function(_amount_multi_currency, string='Total', digits_compute=dp.get_precision('Account')),
    }