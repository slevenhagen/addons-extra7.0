...
class report_account_npg(report_sxw.rml_parse, common_report_header):

    def __init__(self, cr, uid, name, context=None):
        super(report_account_npg, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(report_account_npg, self).set_context(objects, data, new_ids, report_type=report_type)
...
report_sxw.report_sxw('report.npg.account.financial.report', 'account.financial.report',
    'addons/npg_account_report/report/account_financial_report.rml', parser=report_account_npg, header='internal')
