...
<body>
	%for o in objects :
		<table class="main_table"  width="100%">
			<tr>
				...
				<td width="40%" font-size:40px;>
					<b> ${'Straight Bill of Lading'}</b>
				</td>
				<td width="25%">
				    <b> ${'B/L NO'} ${o.name or ''}</b>
				</td>
			</tr>
			<tr>
		...
		<table style="display: inline-block; border: 1px solid; float:right; font-size:10px; " width="49.9%" height="60px">
		<tr>
			<td>
				${"P.O NO. :"} ${o.sale_id and o.sale_id.client_order_ref or ''}<br/>
				${"S.O NO. :"} ${o.sale_id and o.sale_id.name or ''}<br/>
				${"Load Number :"} ${o.truck_load_number or ''|entity}
			</td>
		</tr>
		<tr>
			<td>
		...
		<table style="display: inline-block; float: left; background-color:black; border: 1px solid black; color:white; text-align:center; font-size:13px " width="49.7%" height="24px">
		<tr>
			<td>
            ...
            <table class="table7"  width="100%">
                <tr>
                    <td style=" text-align:left; font-size:9px; border:1px solid black;" width="50%" height="5px">
                        ...
                        ${'exceeding____________________________ per ____________________________'} <br/>
        ...
        <table class="table4"  width="100%">
			...
			%endif
			<table class="table5" width="100%" height="53.5">
				<tr>
					<td width="5%">
		...
		<table class="table5"  width="100%">
			...
			<table class="table7"  width="100%" height="10px">
				<tr>
					<td style=" text-align:left; border:1px solid black; font-size:10px;" width="50%">
						${'RECEIVED Subject to individually determined rates or contracts that have been agreed upon in writing between the carrier and shipper, if applicable otherwise to the rates'}
						${'classifications and rules that have been established by the carrier and are available to the shipper on request. The property described above, in apparent good order except as noted'}
